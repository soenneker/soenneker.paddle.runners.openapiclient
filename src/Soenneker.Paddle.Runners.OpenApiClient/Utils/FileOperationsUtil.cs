...
using Soenneker.Paddle.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Paddle.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Paddle:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/PaddleHQ/paddle-openapi/refs/heads/main/v1/openapi.yaml";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "PaddleOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
